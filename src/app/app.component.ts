...
const backgroundsTable = {
  ...
  8: { number: 8, name: 'Tragic' },
  9: { number: 9, name: 'Performer' },
  10: { number: 10, name: 'Military' },
  11: { number: 11, name: 'Retired' },
  12: { number: 12, name: 'Criminal' },
  13: { number: 13, name: 'Medical' },
  14: { number: 14, name: 'Anachronistic' },
  15: { number: 15, name: 'Exile' },
  16: { number: 16, name: 'Former Villain' },
  17: { number: 17, name: 'Interstellar' },
  18: { number: 18, name: 'Dynasty' },
  19: { number: 19, name: 'Otherworldly' },
  20: { number: 20, name: 'Created' },
};
