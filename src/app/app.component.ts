...
const backgroundsTable = {
  ...
  4: new CharacterBackground(
    ...
    ['History', 'Leadership', 'Select from Physical qualities category'],
    'Expertise',
    [new Die(8), new Die(8)],
    'D8 D8 D8',
    50,
  ...
  15: new CharacterBackground(
    ...
    'Exile',
    'Assign a D10 and D8 to two of these qualities:',
    ['Conviction', 'Insight', 'Select from any Information qualities'],
    'Ideals',
    [new Die(8), new Die(8), new Die(8)],
    'D8 D8 D8',
    53,
  ...
  18: new CharacterBackground(
    ...
    'Dynasty',
    'Assign D10 D10 to two of these qualities:',
    ['Close Combat', 'Fitness', 'History', 'Select from any Social qualities'],
    'Ideals',
    [new Die(8), new Die(8), new Die(6)],
    'D8 D8 and D6',
    54,
  ...
  19: new CharacterBackground(
    ...
    'Otherworldly',
    'Assign a D10 and D8 to two of these qualities:',
    ['Magical Lore', 'Otherworldly Mythos', 'Select from any Mental qualities'],
    'Esoteric',
